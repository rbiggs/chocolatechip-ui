...
# Copy ChUI files to new directory:
...
# Write base app file to directory:
html = open(path + name + '/index.html', 'w')
html.write(app);
html.close()

# If images flag is set to true, create images directory:
...
# If the icons are a list, copy the list items to the new directory:
