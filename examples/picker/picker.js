...
var Picker = {
	...
	create: function () {
		...
		div.innerHTML = '<div id="sgwt-toolbar" class="sgwt-toolbar sgwt-custom-tint hbox" style="background-color: #333;">\
		<div id="sgwt-picker-cancel" class="sgwt-button bordered sgwt-custom-tint" style="background-color: #333;">\
			<span class="pointer" style="background-color: #333;"></span>\
			<div class="button-content">\
				<span class="label">Cancel</span>\
			</div>\
		</div>\
		<div class="flex1"></div>\
		<div id="sgwt-picker-done" class="sgwt-button bordered important">\
			<span class="pointer"></span>\
			<div class="button-content">\
				<span class="label">Done</span>\
			</div>\
		</div>\
		</div><div id="sgwt-slots-wrapper"><div id="sgwt-slots"></div></div>\
