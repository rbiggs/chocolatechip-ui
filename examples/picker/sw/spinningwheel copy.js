 ...
 $.extend($, {
 	UIPicker :  {
		...
		create: function () {
			...
			div.innerHTML = '<toolbar id="sw-header"><uibutton ui-implements="cancel" id="sw-cancel"><label>Cancel</label></uibutton><uibutton ui-implements="done" id="sw-done"><label>Done</label></uibutton></' + 'toolbar><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
		...
		destroy: function () {
			...
			document.body.removeChild(document.getElementByTagName('picker')[0]);
		},
...
var SpinningWheel = {
	...
	handleEvent: function (e) {
		if (e.type == 'touchstart') {
			...
			if (e.target.nodeName == 'sw-wrapper') {
				this.destroy();
			} else {
				this.backWithinBoundaries(e);
			}
