 ...
 $.extend($, {
 	UIPicker :  {
		...
		create: function () {
			...
			div.innerHTML = '<toolbar><uibutton ui-implements="cancel" id="sw-cancel"><label>Cancel</label></uibutton><uibutton ui-implements="done" id="sw-done"><label>Done</label></uibutton></' + 'toolbar><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
